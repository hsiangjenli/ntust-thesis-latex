...
% Chapter style
\def\chapterfontsize{20pt}
\newlength{\chaptertitlespacing}
\setlength{\chaptertitlespacing}{\dimexpr \chapterfontsize + \chapterfontsize / 2 \relax}
\titlespacing{\chapter}{0pt}{-3\topskip}{\chaptertitlespacing}