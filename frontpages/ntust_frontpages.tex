...
\begin{figure}[htbp]
	\begin{minipage}[b]{5cm} 
		...
		\includegraphics[width=1.1in]{figures/ntust/logo.png}
...
\hspace{3.5cm} \makebox[4cm][s]{\Large{研~究~生：}}
\Large{\myCname}  % 顯示作者中文名
\hfill \makebox[1cm][s]{}\\
%
\vspace{0.3cm}
\hspace{3.5cm} \makebox[4cm][s]{\Large{學號：}}
\Large{\myStudentID}  %顯示指導教授A中文名
\hfill \makebox[1cm][s]{}\\
%
\vspace{1cm}
\hspace{3.5cm} \makebox[4cm][s]{\Large{指導教授：}}
...
% According to the NTUST's library regulation, the watermark will automatically be added when you upload the pdf file to the library system.
% If you want to add the watermark in the pdf file, you can use the following command:
% \SetWatermarkText{\includegraphics{figures/ntust/watermark.png}}
...
% Acknowledgment
\newpage
\chapter*{\protect\makebox[6.5cm][s]{\nameAckn}} %\makebox{} is fragile; need protect
\addcontentsline{toc}{chapter}{\nameAckn}
...
% Table of contents
\newpage
\renewcommand{\contentsname}{\protect\makebox[6cm][s]{\nameToc}}
